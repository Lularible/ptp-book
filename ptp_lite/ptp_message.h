...
/* PTP message header - IEEE 1588-2019 Table 35 (34 bytes) */
typedef struct {
    ...
    uint8_t  minor_sdoid;               /* Octet 5: minorSdoId */
    uint16_t flag_field;                /* Octets 6-7: flag field */
    uint64_t correction_field;          /* Octets 8-15: correction field */
    uint32_t message_type_specific;     /* Octets 16-19: messageTypeSpecific */
...
/* Clock Quality structure (4 bytes) - IEEE 1588-2019 */
typedef struct {
...
/* Announce message (64 bytes) - IEEE 1588-2019 Table 43 */
typedef struct {
    ptp_header_t header;                     /* 34 bytes */
    ptp_timestamp_t origin_timestamp;        /* 10 bytes */
